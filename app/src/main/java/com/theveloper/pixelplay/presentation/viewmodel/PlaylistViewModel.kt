...
data class PlaylistUiState(
    ...
    val showMrbifyCloudPlaylists: Boolean = true,
...
class PlaylistViewModel @Inject constructor(
    ...
    init {
        ...
        observeMrbifyCloudPlaylistVisibility()
    ...
    private fun observeMrbifyCloudPlaylistVisibility() {
        viewModelScope.launch {
            playlistPreferencesRepository.showMrbifyCloudPlaylistsFlow.collect { show ->
                _uiState.update { it.copy(showMrbifyCloudPlaylists = show) }
            }
        }
    }
    ...
    fun setShowMrbifyCloudPlaylists(show: Boolean) {
        if (_uiState.value.showMrbifyCloudPlaylists == show) return

        _uiState.update { it.copy(showMrbifyCloudPlaylists = show) }
        viewModelScope.launch {
            playlistPreferencesRepository.setShowMrbifyCloudPlaylists(show)
        }
    }
