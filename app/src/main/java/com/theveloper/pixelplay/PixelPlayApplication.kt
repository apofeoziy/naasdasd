...
class PixelPlayApplication : Application(), ImageLoaderFactory, Configuration.Provider {
    ...
    @Inject
    lateinit var mrbifyStreamProxy: com.theveloper.pixelplay.data.stream.MrbifyStreamProxy
    ...
    override fun onCreate() {
        ...
        // Start Mrbify proxy immediately (no heavy native deps)
        mrbifyStreamProxy.start()
