...
object AppModule {
    ...
    /**
     * Retrofit instance for Mrbify API.
     */
    @Provides
    @Singleton
    @MrbifyRetrofit
    fun provideMrbifyRetrofit(okHttpClient: OkHttpClient): Retrofit {
        return Retrofit.Builder()
            .baseUrl("https://mrbify.vercel.app/api/")
            .client(okHttpClient)
            .addConverterFactory(GsonConverterFactory.create())
            .build()
    }
    ...
    @Provides
    @Singleton
    fun provideMrbifyApiService(@MrbifyRetrofit retrofit: Retrofit): com.theveloper.pixelplay.data.network.mrbify.MrbifyApiService {
        return retrofit.create(com.theveloper.pixelplay.data.network.mrbify.MrbifyApiService::class.java)
    }
    ...
    @Provides
    @Singleton
    fun provideMrbifyRepository(apiService: com.theveloper.pixelplay.data.network.mrbify.MrbifyApiService): com.theveloper.pixelplay.data.repository.MrbifyRepository {
        return com.theveloper.pixelplay.data.repository.MrbifyRepository(apiService)
    }
