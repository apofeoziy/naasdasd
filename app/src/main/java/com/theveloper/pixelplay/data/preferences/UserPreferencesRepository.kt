...
constructor(
    ...
    private object PreferencesKeys {
        ...
        // Mrbify Auth
        val MRBIFY_USER_ID = stringPreferencesKey("mrbify_user_id")
        val MRBIFY_USERNAME = stringPreferencesKey("mrbify_username")
        val MRBIFY_TOKEN = stringPreferencesKey("mrbify_token")
        val MRBIFY_AVATAR_URL = stringPreferencesKey("mrbify_avatar_url")
    }
    ...
    val showMrbifyCloudPlaylistsFlow: Flow<Boolean> = dataStore.data
        .map { preferences ->
            preferences[PreferencesKeys.SHOW_MRBIFY_CLOUD_PLAYLISTS] ?: true
        }
    ...
    suspend fun setShowMrbifyCloudPlaylists(show: Boolean) {
        dataStore.edit { preferences ->
            preferences[PreferencesKeys.SHOW_MRBIFY_CLOUD_PLAYLISTS] = show
        }
    }
