...
class PlaylistPreferencesRepository @Inject constructor(
    ...
    val showMrbifyCloudPlaylistsFlow: Flow<Boolean> =
        userPreferencesRepository.showMrbifyCloudPlaylistsFlow
    ...
    suspend fun setShowMrbifyCloudPlaylists(show: Boolean) =
        userPreferencesRepository.setShowMrbifyCloudPlaylists(show)
